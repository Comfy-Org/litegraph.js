...
export abstract class NodeSlot implements INodeSlot {
  ...
  /**
   * Whether this slot is a match for the given slot type.
   * @param type The slot type to check against.
   */
  isValidTarget(type: ISlotType): boolean {
    return LiteGraph.isValidConnection(this.type, type)
  }
